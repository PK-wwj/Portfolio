...
2. **Use AutoSum to calculate values:** Use AutoSum to find the following values for column ‘C’ and record each of the values:
   ...
   - COUNT 
     ...
     ![image-20260101220021453](Assets/Images/image-20260101220021453.png)
...
4. **Sort the pivot table data:** Use the Sort By Value setting on the pivot table to sort it in descending order by the sum of equipment count.
   ...
   click A2 down arrow ,choose sort by value   ![image-20260101220045859](Assets/Images/image-20260101220045859.png)

   ![image-20251229213710856](C:\Users\27950\AppData\Roaming\Typora\typora-user-images\image-20251229213710856.png![image-20260101220045859](Assets/Images/image-20260101220045859.png)
...
6. **Analyze data in the pivot table:** Use the PivotTable Fields pane to manipulate and analyze data in the two copied pivot table as follows:
   ...
   - Collapse all fields except the top one - **Transportation**   ![image-20260101220057198](Assets/Images/image-20260101220057198.png)

   ![image-20251229215210424](C:\Users\27950\AppData\Roaming\Typora\typora-user-images\image-20251229215210424.png![image-20260101220057198](Assets/Images/image-20260101220057198.png)
>>>>>>> 072c1016aa094bb2608d5acfd2a51e06778d60cb
   ...
   - Collapse all fields except the top one - **CUV**
        ![image-20260101220131129](Assets/Images/image-20260101220131129.png)

  *Format the data as a table:** Use the Format as Table option to format the data as a table.

1. Choose all data, Insert->Table
...
4. **Sort the pivot table data:** Use the Sort By Value setting on the pivot table to sort it in descending order by the sum of equipment count.
   ...
   ![image-20260101220045859](Assets/Images/image-20260101220045859.png)
...
6. **Analyze data in the pivot table:** Use the PivotTable Fields pane to manipulate and analyze data in the two copied pivot table as follows:
   ...
   ![image-20260101220057198](Assets/Images/image-20260101220057198.png)
   ...
   ![image-20251229215316077](C:\Users\27950\AppData\Roaming\Typora\typora-user-images\image-20251229215316077.png![image-20260101220131129](Assets/Images/image-20260101220131129.png)
...
>>>>>>> 4e236258c53a84f12a9775270ca4772f63090d38
>>>>>>> 072c1016aa094bb2608d5acfd2a51e06778d60cb
